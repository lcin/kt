...
<link href="/Public/Home/css/loginout.css" type="text/css" rel="stylesheet">
</head>
        ...
        <div class="m-navrgt f-fr f-cb f-pr j-navright">
		 ...
		 <!-- <?php if($_SESSION["id"] != null): ?><div id="login">
			...
			<div id="login1">
				...
				<div><a href="/index.php/Login/loginout/id/<?php echo ($_SESSION["id"]); ?>">退出</a></div>
			</div>
		 </div><?php endif; ?> -->
...
<div class="g-flow"> <b class="b-20"></b>
  <div class="g-logout f-bg">
    <div class="m-logcnt f-pr"> <b class="b-30"></b><b class="b-30"></b>
      <div class="txt">
		<span >已经成功退出登录<span>
	  </div>
      <p class="sug f-fs0">有意见或建议？<a href="/index.php/User/advice" target="_blank">反馈给我们<span class="f-ib feedicon"></span></a></p>
      <a class="reLogin btn" id="j-reLogin" style="color:#26A266" href="/index.php/Login/index">重新登录</a>
      <div class="f-pa toiPad">
        <p>云课堂App</p>
        <a href="#" target="_blank">查看详情&gt;&gt;<br/><img src="/Public/Home/imgs/loginout(1).png"></a>
		
	  </div>
    </div>
    <div class="m-logbot"> <span class="itm f-fs0" id="j-motto">行动是通往知识的唯一道路。    ——   萧伯纳</span> </div>
  </div>
</div>
<div class="g-ft">
        ...
        <div class="share f-cb">
		  ...
		  <a href="javascript:void(0)" class="yixin f-pr" data-index="关注我们_易信">
			...
			<div class="tipQrcode f-pa">
				<div class="qrImag">
					<img src="/Public/Home/imgs/yixin.png" width="120px" height="120px" alt="加云课堂易信好友">
				</div>
				<p class="qrTitle">易信号：study163</p>
				<div class="tip f-pa"></div>
			</div>
          </a> 
		  <a href="javascript:void(0)" class="weixin f-pr" data-index="关注我们_微信"><img src="/Public/Home/imgs/4.png">
			  <div class="tipQrcode f-pa">
				<div class="qrImag">
