                            ...
                            <div id ="hh"class="m-data-lists f-cb f-pr j-data-list"style="width:100%">
                                ...
                                <?php if(is_array($datas)): foreach($datas as $key=>$datas): ?><div style="margin-top: 50px" class="u-cover u-find-cover first" id="auto-id-1449466894429" style="margin-left:14px">
                                        <div   class="wrap f-cb">
                                                <div  class="img">
                                                    <div class="tit">
                                                        <h3 class="f-thide"><?php echo ($datas["activityname"]); ?></h3>
                                                    </div>
                                                    <div class="orgName f-fs0 f-thide"><?php echo ($datas["introduce"]); ?></div>
                                                    <div class="thumb">
                                                        <div  style="height:20px;background:white;margin-top:10px;">
                                                                <span class="normal f-fs0" style="color:#FE4000;font-size:12px"><b>¥<?php echo ($datas["money"]); ?></b></span>
                                                        </div>
                                                    </div>
                                                    <a href="/index.php/Activity/xiangqing/activityid/<?php echo ($datas["activityid"]); ?>">查看详情</a>
                                                </div>
