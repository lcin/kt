                        ...
                        <div id="auto-id-1450193523781" style="" class="about_con j-aboutCon f-bg f-pr f-cb" data-type="8">
                            ...
                            <div class="about_content j-aboutContent">
                                <div class="m-feedbackSys">
                                    <form method="post" action="/index.php/Course/joincourse">
                                        <?php if(is_array($datas)): foreach($datas as $key=>$datas): endforeach; endif; ?>
                                        <?php if(is_array($data)): foreach($data as $key=>$data): endforeach; endif; ?>
                                        <div class="title f-cb">
                                            <h2 style="color: red" class="feed-tit">您参加的课程是：<?php echo ($datas["title"]); ?></h2>
                                        </div>
                                        <div class="title f-cb">
                                                    ...
                                                    <div class="m-nesIpt f-cb auto-1450193523645">
                                                        <div class="area j-inputArea f-fl auto-1450193523612-parent">
                                                            <div style="width: 500px; height: 35px;" class="m-baseinputui auto-1450193523612">
                                                                <textarea style="width:500px; height:25px;" id="auto-id-1450193523802" name="username" class="j-textarea inputtxt"><?php echo ($data["username"]); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="m-nesIpt f-cb auto-1450193523645">
                                                        <div class="area j-inputArea f-fl auto-1450193523612-parent">
                                                            <div style="width: 500px; height: 32px;" class="m-baseinputui auto-1450193523612">
                                                                <textarea  style="width: 500px; height: 25px;" id="auto-id-1450193523828" name="phone" class="j-textarea inputtxt" placeholder=""><?php echo ($data["id"]); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type="hidden"name="uid"value="<?php echo ($_SESSION["id"]); ?>"/>
                                                <input type="hidden"name="money"value="<?php echo ($datas["price"]); ?>"/>
                                                <input type="hidden"name="vid"value="<?php echo ($datas["id"]); ?>"/>
                                                <input type="hidden"name="videoname"value="<?php echo ($datas["title"]); ?>"/>
                                                <input type="hidden"name="nid"value="<?php echo ($datas["nid"]); ?>"/>
