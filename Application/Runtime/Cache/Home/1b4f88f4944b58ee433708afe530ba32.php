	...
	<div id="j-catbox" class="m-catebox f-pr f-cb">
		<ul class="level-1">
			...
			<?php if(is_array($types)): foreach($types as $key=>$type): ?><li class="level-1-item f-pr selected" id="catId-3">
				<a href="/index.php/id/<?php echo ($type["id"]); ?>" class="myType" value="<?php echo ($type["id"]); ?>"> <?php echo ($type["name"]); ?></a>
				<span class="arrow"> 
					<span class="arrow_wrap arrow-wrap-trsp"> 
						<i class="arrow-border"></i> 
						<em class="arrow-cnt"></em> 
		...
		<div class="g-mn2c">
			...
			<div id ="logo" class="m-slide f-pr" id="j-slideBox">
				<a class="slide j-slide" target="_blank" id="auto-id-1449466894351" href="" data-index="2">
					<?php if(is_array($advs)): foreach($advs as $key=>$advs): switch($advs["place"]): case "0": ?><img id="auto-id-1449466894546" src="/Public/Upload/<?php echo ($advs["pic"]); ?>" style="opacity: 1; transition-property: opacity; transition-duration: 1s; transition-timing-function: ease-in-out; border='1px solid blue'"><?php break; endswitch; endforeach; endif; ?>
					<!-- <img id="auto-id-1449466894546" src="/Public/Home/imgs/567256d653ec6.jpg" style="opacity: 1; transition-property: opacity; transition-duration: 1s; transition-timing-function: ease-in-out; border='1px solid blue'">
					<img id="auto-id-1449466894546" src="/Public/Home/imgs/6630608169839812534.jpg" style="opacity: 1; transition-property: opacity; transition-duration: 1s; transition-timing-function: ease-in-out; border='1px solid blue'"> -->
				</a>
        ...
        <div id="j-courseNode" class="lists auto-1449466894196-parent">
			...
			<div class="m-basepool f-cb auto-1449466894196">
				...
				<?php if(is_array($typeData)): foreach($typeData as $key=>$ty): ?><div class="u-cover u-find-cover first" id="auto-id-1449466894429" style="margin-left:14px">
						<div class="wrap f-cb">
							<a href="/index.php/Course/index/id/<?php echo ($ty["id"]); ?>" target="_blank" class="j-href wrap" data-href="/course/introduction/1367011.htm" data-index="1" data-name="C/C++黑客编程项目实战课程  【择善教育】">

							<div class="img">
								<div class="pic f-pr">
									<img class="imgPic" src="/Public/Upload/<?php echo ($ty["video"]); ?>" alt="C/C++黑客编程项目实战课程  【择善教育】">
								</div>
								<div class="tit">
...
<script>
	   $(".myType").click(function(){
			var id = $(this).attr('value');
		     $.post("/index.php/Type/type",{"id":id},function(data){
				var len=data.length;
				var html="";
				for(var i=0;i<len;i++){
	   ...
	   $(".A").live("click",function(){
	        var id =$(this).attr('dd');
			$.post("/index.php/Type/video",{"id":id},function(data){
			
			//var len=data.length;
			var html ="";
			for(var i in data){
				html +="<div class='u-cover u-find-cover first' id='auto-id-1449466894429'style='margin-left:14px'><div class='wrap f-cb'><a href='/index.php/Course/index/id/"+data[i]['id']+"' target='_blank' class='j-href wrap' data-href='/course/introduction/1367011.htm' data-index='1' data-name='C/C++黑客编程项目实战课程  【择善教育】'><div class='img'><div class='pic f-pr'> <img class='imgPic' src='/Public/Upload/"+data[i]['video']+"' alt='C/C++黑客编程项目实战课程  【择善教育】'> </div><div class='tit'><h3 class='f-thide'>"+data[i]['title']+"</h3><div class='continued sign '>老师参与</div><div class='continued sign foxconn2 f-dn foxconn'></div></div><div class='orgName f-fs0 f-thide'>"+data[i]['tname']+"</div><div class='thumb'><div class='desc f-cb'> <span class='hot f-fs0'>"+data[i]['number']+"</span></div><div style='height:20px;background:white;margin-top:10px;'><span class='normal f-fs0'style='color:red;font-size:20px'>"+data[i]['price']+"</span> <span class='discount'></span> </div></div><div class='f-dn'></div></div></a><div class='j-mask mask' data-id='1367011' style='display:none'><div class='j-del delbtn'></div></div></div></div>";
			}
			 $("#hh").html(html);
		  },"json"); 
