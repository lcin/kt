		 ...
		 <?php if($_SESSION["id"] != null): ?><div id="login">
            ...
            <div class="m-nav f-cb j-navFind"> <a data-index="首页" class="nitem" href="/index.php" hidefocus="true">首页</a>
                ...
                <?php if($_SESSION["id"] != null): ?><a data-index="软件需求" class="nitem f-f0" href="/index.php/Demand/demand" hidefocus="true">软件需求</a>
                    <?php else: ?>
                    <a data-index="软件需求" class="nitem f-f0" href="/index.php/Login/index" hidefocus="true">软件需求</a><?php endif; ?> <div class="nitem f-f0 x-hoverItem" hidefocus="true"> <span class="j-dropmenubtn" data-href="/client/download.htm" id="auto-id-1449466857063">下载APP</span>
  ...
  <div class="g-bd">
    <div class="" id="m-msgbox">
      <div class="m-msglist f-bg">
        <div class="tabarea">
		<a id="big-type-sys" class="f-fl f-pr tab tab-w tab-pos">
		系统通知
         
          </a>
          <div class="f-fr f-pr" id="auto-id-1450516114812">
            ...
            <div class="m-basepool f-cb auto-1450516114652">
              <div class="m-data-lists f-cb f-pr j-data-list" style="">
                <div class="u-msgItem f-fs0 first">
				  <?php if(is_array($infos)): foreach($infos as $key=>$info): ?><div class="j-msg-item msg-cnt msg-unread" id="auto-id-1450516114910">
				
                    <div class="f-cb msg-con" style="height:10px">
					
					
                      <div class="msg-txt f-fl s-fc1"><span style="color:green">[<?php echo ($info["title"]); ?>] 　</span><?php echo ($info["content"]); ?>
					  
					  </div>
					
					  
                      <div class="msg-close f-pa" title="删除" id="auto-id-1450516114911" style="">
					  </div>
                      <div class="msg-mark msg-mark-hover f-pa" title="标记为已读" id="auto-id-1450516114909" style="display: none;">
					  </div>
                    </div>
                    <div class="msg-time"><?php echo ($info["time"]); ?></div>
