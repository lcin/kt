                        ...
                        <div id="person-course-box" class="personCourse">
                            <div class="g-mn2">
                                <div class="g-mn2c f-bg j-coursewrapper">
                                    <div class="j-tabs courseTabs"> <a id="auto-id-1450352531621" class="f-ib f-pa tab1 cur">参加的课程</a>
                                    </div>
                                        ...
                                        <div class="emptytext">
                                            <?php if(is_array($datas)): foreach($datas as $key=>$datas): ?><div style="margin-top: 50px" class="u-cover u-find-cover first" id="auto-id-1449466894429" style="margin-left:14px">
                                                    <div   class="wrap f-cb">
                                                        <div  class="img">
                                                            <div class="tit">
                                                                <h3 class="f-thide">课程名称：<?php echo ($datas["videoname"]); ?></h3>
                                                            </div>
                                                            <div class="orgName f-fs0 f-thide">加入课程时间：<?php echo ($datas["jointime"]); ?></div>
                                                            <div class="orgName f-fs0 f-thide">课程讲师：<?php echo ($datas["tname"]); ?></div>
                                                            ...
                                                            <a href="/index.php/Course/kechengdetail/id/<?php echo ($datas["vid"]); ?>">查看详情</a>
                                                        </div>
                                                    </div>
                                                    <a  class="red" href="/index.php/Course/deljoin/joinid/<?php echo ($datas["joinid"]); ?>">
                            ...
                            <div class="g-sd2 f-bg">
                                <div class="m-center-side">
                                    <div class="top">
                                        ...
                                        <a class="f-fr" href="/index.php/Course/personal">更多</a> </div>
                                    <div class="bottom">
