...
#personal > div:first-of-type img:first-of-type{
	float:left;
	width:65px;
	height:70px;
	margin-left:110px;
...
#personal > div:first-of-type > div:nth-of-type(3) img{
	width:20px;
	height:20px;
	float:left;
	margin-left:10px;
...
#personal > div:nth-of-type(2) > div:first-of-type > a:first-of-type{
	margin-right:20px;
}
#personal > div:nth-of-type(2) > div:first-of-type > a{
	float:right;
	color:#9C9C9C;
	margin-left:40px;
	margin-top:15px;
}
#personal > div:nth-of-type(2) > div:first-of-type > a:hover{
	color:#10AD5A;
	text-decoration:underline;
}

#personal > div:nth-of-type(2) > div:nth-of-type(2) > div{
	margin-top:40px;
	margin-left:30px;

}
#personal > div:nth-of-type(2) > div:nth-of-type(2) > div span:nth-of-type(2){
	margin-left:20px;
	font-size:15px;

}
#personal > div:nth-of-type(2) > div:nth-of-type(2) > div span:first-of-type{
	color:#CECECE;
...
<div id="personal">
	<div>
		...
		<div>
			<?php if($data["sex"] == 1): ?><img src="/Public/Home/imgs/b.bmp"/>
			<?php elseif($data["sex"] == 0): ?>
			<img src="/Public/Home/imgs/g.bmp"/>
			<?php else: ?>
			<img src="/Public/Home/imgs/n.jpg"/><?php endif; ?>
		</div>
	</div>
	<div>
		<div>
			<a href="/index.php/Detail/index/id/<?php echo ($_SESSION["id"]); ?>">编辑我的资料</a>
			<a href="/index.php/Detail/personal">前往个人首页</a>
		</div>
		<div>
			<div>
				<span>昵称:</span><span><?php echo ($data["username"]); ?></span><br/>
			</div>
			<div>
				<span>性别:</span><span>	
			<?php if($data["sex"] == 0): ?>女
			...
			<div>
				<span>个人经历:</span><span><?php echo ($data["description"]); ?></span><br/>
			</div>
			<div>
				<span>教育经历:</span><span><?php echo ($data["edu"]); ?></span><br/>
			</div>
			<div>
				<span>擅长:</span><span><?php echo ($data["special"]); ?></span><br/>
			</div>
		</div>
	</div>
</div>
