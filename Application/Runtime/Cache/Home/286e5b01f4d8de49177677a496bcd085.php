					  ...
					  <div class="u-rating" name="">
						...
						<span class="j-tip"></span>
                            ...
                            <div>
                                    ...
                                    <?php if($_SESSION["id"] != null): ?><a class="a" style="margin-left: 20px" id="add" href="/index.php/Activity/add/activityid/<?php echo ($data["activityid"]); ?>">加入活动</a>
                                        <?php else: ?>
                                        <a class="a" style="margin-left: 20px" href="/index.php/Login/index">加入活动</a><?php endif; ?>
