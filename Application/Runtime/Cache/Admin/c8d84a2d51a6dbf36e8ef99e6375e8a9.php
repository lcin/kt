...
<html lang="en">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form action='/admin.php/Activity/index' method="get">
                <div class="seachform" >
                    活动标题<input name="title" type="text" placeholder="请输入标题" class="scinput" />
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-responsive">
                                <form action="/admin.php/Activity/del">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php if(is_array($datas)): foreach($datas as $key=>$data): ?><tbody>
                                            <tr>
                                                <td><?php echo ($num++); ?></td>
                                                <td><?php echo ($data["adminname"]); ?></td>
                                                <td><?php echo ($data["activityname"]); ?></td>
                                                <td><?php echo ($data["nowtime"]); ?></td>
                                                <td><?php echo ($data["applytime"]); ?></td>
                                                <td><?php echo ($data["begintime"]); ?></td>
                                                <td><?php echo ($data["closetime"]); ?></td>
                                                <td><?php echo ($data["overtime"]); ?></td>
                                                <td><?php echo ($data["money"]); ?></td>
                                                <td><?php echo ($data["introduce"]); ?></td>
                                                <td><?php echo ($data["place"]); ?></td>
                                                <td><?php echo ($data["phone"]); ?></td>
                                                <td><?php echo ($data["wuping"]); ?></td>
                                                <td><?php echo ($data["people"]); ?></td>
                                                <td><?php echo ($data["remark"]); ?></td>
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a class="red" href="/admin.php/Activity/del/activityid/<?php echo ($data["activityid"]); ?>">
                                        ...
                                        <tr>
                                            <td colspan="16"><?php echo ($page); ?></td>
                                        </tr>
                                    </table>
