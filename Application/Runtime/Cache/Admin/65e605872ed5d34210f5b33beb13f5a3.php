					...
					<div class="page-content">
						<div class="page-header">
						 ...
						 <form action='/admin.php/User/index' method="get">
							<div class="seachform" >
							邮箱: <input name="email" type="text" placeholder="请输入邮箱名" class="scinput" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/admin.php/User/del">
											...
											<?php if(is_array($users)): foreach($users as $key=>$user): ?><tbody>
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" name="id[]" value="<?php echo ($user["id"]); ?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td class="hidden-480"><?php echo ($user["pwd"]); ?></td>
														<td><?php echo ($user['status'] == '0'? "禁用" :"启用"); ?></td>

														<td>
														
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/admin.php/User/status/id/<?php echo ($user["id"]); ?>/status/<?php echo ($user["status"]); ?>">
																	<i class="icon-lock">
																		<?php echo ($user['status'] == 0 ?"启用":"禁用"); ?>
																	
																	</i>
																	
																</a>
																<a class="blue" href="/admin.php/User/select/id/<?php echo ($user["id"]); ?>">
																...
																<a class="green" href="/admin.php/User/mod/id/<?php echo ($user["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/admin.php/User/del/id/<?php echo ($user["id"]); ?>">
