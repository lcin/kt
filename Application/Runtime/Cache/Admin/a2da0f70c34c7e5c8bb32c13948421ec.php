        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/admin.php/Video/add" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                            ...
                            <div class="tabbable">
                                ...
                                <div class="tab-content">
                                    <div id="home4" class="tab-pane in active">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-select-2">视频分类</label>
                                            <div class="col-sm-9">
                                                <select name="tid" class="col-xs-10 col-sm-5" style="width: 13%; margin-right: 10px;" id="form-field-select-2">
													<option value="0" selected="selected">选择分类</option>
                                                    <?php if(is_array($data)): foreach($data as $key=>$datas): ?><option value="<?php echo ($datas["id"]); ?>"><?php echo ($datas["name"]); ?></option><?php endforeach; endif; ?>
                                                </select>
                                                <select name="tid1" class="col-xs-10 col-sm-5" style="width: 13%; margin-right: 10px;" id="form-field-select-2-1">
        ...
        <script type="text/javascript">
			$("[name='tid']").change(function(){
				...
				if(val == 0){
					...
					var url="/admin.php/Video/search/id/"+val;
					$.get(url,function(d){
						//alert(d);
						html = "";
						var data = eval("("+d+")");
            ...
            $('#form-field-select-2').change(function() {
                ...
                $.ajax({
                    url: "/admin.php/Video/getChildCate/",
