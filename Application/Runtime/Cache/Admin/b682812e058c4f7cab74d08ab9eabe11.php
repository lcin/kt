					...
					<div class="page-content">
						<div class="page-header">
							<h1>
							 ...
							 <form action='/admin.php/Admin/index' method="get">
							<div class="seachform" >
							管理员: <input name="name" type="text" placeholder="请输入管理员" class="scinput" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/admin.php/Admin/del">
													...
													<tr>
														<th class="center">
															<label>
																...
																<input type="submit" value="删除" class="btn btn-primary btn-xs">
															</label>
														</th>
														<th>编号</th>
											...
											<?php $num = '1'; ?>
											<?php if(is_array($admins)): foreach($admins as $key=>$admin): ?><tbody>
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" name="id[]" value="<?php echo ($admin["id"]); ?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td class="hidden-480">
															...
															<img src="/Public/Upload/<?php echo ($admin["photo"]); ?>" width="40" height="40">
														</td>
														<td><?php echo ($admin['status'] ? "启用" :"禁用"); ?></td>
														<td>
															<a href="/admin.php/Group/index/title/<?php echo ($admin["title"]); ?>" class="btn btn-app btn-pink btn-sm">
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/admin.php/Admin/status/id/<?php echo ($admin["id"]); ?>/status/<?php echo ($admin["status"]); ?>">
																	<i class="icon-lock">
																		<?php echo ($admin['status'] ? "禁用":"启用"); ?>
																	
																	</i>
																	
																</a>

																<a class="green" href="/admin.php/Admin/mod/id/<?php echo ($admin["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/admin.php/Admin/del/id/<?php echo ($admin["id"]); ?>">
