...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
						 ...
						 <form action='/admin.php/Auth/ruleIndex' method="get">
							<div class="seachform" >
							规格名: <input name="title" type="text" placeholder="请输入规格名" class="scinput" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/admin.php/Auth/delRule">
											...
											<?php if(is_array($rules)): foreach($rules as $key=>$rule): ?><tbody>
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" name="id[]" value="<?php echo ($rule["id"]); ?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td><?php echo ($rule['status'] ? "启用" :"禁用"); ?></td>

														<td>
														
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/admin.php/Auth/modStatus/id/<?php echo ($rule["id"]); ?>/status/<?php echo ($rule["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/admin.php/Auth/modRule/id/<?php echo ($rule["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/admin.php/Auth/delRule/id/<?php echo ($rule["id"]); ?>">
