					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/admin.php/Auth/addRule">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 权限名称</label>

										<div class="col-sm-9">
											<input  type="text"  name="title" class="col-xs-10 col-sm-5" id="form-input-readonly" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">权限规则</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="name" class="col-xs-10 col-sm-5" />
