					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="/admin.php/Video/add.html">
										<i class="icon-double-angle-right"></i>
										添加
									</a>
								</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/admin.php/Type/add_parent">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 添加分区 </label>

										<div class="col-sm-9">
											<input  type="text"  name="name" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="添加类型" />
