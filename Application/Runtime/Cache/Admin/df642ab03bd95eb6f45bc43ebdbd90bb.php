					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/admin.php/Group/add">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 管理组名称</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">管理组规则</label>
									  
										<div class="col-sm-9">
											  <?php if(is_array($rules)): foreach($rules as $key=>$rule): ?><input type="checkbox" name="rules[]" value="<?php echo ($rule["id"]); ?>"  />
												<?php echo ($rule["title"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?>
										</div>
