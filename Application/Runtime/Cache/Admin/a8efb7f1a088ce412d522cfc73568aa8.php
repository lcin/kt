        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action='/admin.php/Organ/add' role="form" method='post' >
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" id="username" name="username" for="form-field-1"> 合作机构名称 </label>

                            <div class="col-sm-9">
                                <input type="text" placeholder="请输入合作机构名称" class="col-xs-10 col-sm-5"  name="name" />
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" name="url" for="form-field-2"> 合作机构地址</label>

                            <div class="col-sm-9">
                                <input type="text" name='url' value="study/admin.php/Organ/index.html"  placeholder="请输入合作机构网址" class="col-xs-10 col-sm-5" />
                                
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" name="url" for="form-field-2"> 合作机构描述</label>

                            <div class="col-sm-9">
                                <textarea  type="text"  name="description" placeholder="请输入合作机构描述信息" class="col-xs-10 col-sm-5" style="width:325px;height:150px">
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                               ...
                               <!--<a href='/admin.php/Organ/index' class="btn btn-info" type="submit" name='sub'>
