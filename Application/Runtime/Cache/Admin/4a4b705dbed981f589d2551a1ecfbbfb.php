        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action='/admin.php/Teacher/mod' role="form" method='post' enctype="multipart/form-data" >
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" id="username" name="username" for="form-field-1"> 讲师名称 </label>

                            <div class="col-sm-9">
                                <input type="text"  class="col-xs-10 col-sm-5"  name='tname' value="<?php echo ($teacher["tname"]); ?>" />
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" name="url" for="form-field-2"> 讲师机构</label>

                            <div class="col-sm-9">
                                <input type="text" name='organ' value="<?php echo ($teacher["organ"]); ?>"  class="col-xs-10 col-sm-5" />
                                
                            </div>
                        </div>
						
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" name="url" for="form-field-2"> 讲师头像</label>
						...
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" name="url" for="form-field-2"> 讲师介绍</label>

                            <div class="col-sm-9">
                                <textarea  type="text"  name='description'value="<?php echo ($teacher["description"]); ?>" class="col-xs-10 col-sm-5" style="width:325px;height:150px">
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                               <input type='submit' name='sub' class="btn btn-info" value='修改'/>
                               <input type='hidden' name='id' class="btn btn-info" value='<?php echo ($teacher["id"]); ?>'/>
                              
                               <!--<a href='/admin.php/Teacher/index' class="btn btn-info" type="submit" name='sub'>
