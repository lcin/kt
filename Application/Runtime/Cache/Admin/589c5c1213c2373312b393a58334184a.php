        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/admin.php/Type/add_video" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                    ...
                                    <div id="home4" class="tab-pane in active">
										...
										<div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 讲师选择 </label>
                                             ...
                                             <div class="col-sm-9">
												<select name="nid">
													...
													<?php if(is_array($datas)): foreach($datas as $key=>$data): ?><option value="<?php echo ($data["id"]); ?>"><?php echo ($data["tname"]); ?></option><?php endforeach; endif; ?>
													
												</select>
												<?php if($_GET): else: ?>
													课程类型<select name="tid">
														    <option>__未选择__</option>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
												 <input type="hidden"  name="replace" value="<?php echo ($_GET['tid']); ?>"  value="添加" class="btn btn-info">
                                                <input type="text" name="title" id="form-field-1" placeholder="输入课程标题" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="price" id="form-field-1" placeholder="输入课程价格" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11"> 课程图片 </label>
        ...
        <script type="text/javascript">
			$("[name='tid']").change(function(){
				...
				if(val == 0){
					...
					var url="/admin.php/Type/search/id/"+val;
					$.get(url,function(d){
						//alert(d);
						html = "";
						var data = eval("("+d+")");
            ...
            $('#form-field-select-2').change(function() {
                ...
                $.ajax({
                    url: "/admin.php/Type/getChildCate/",
