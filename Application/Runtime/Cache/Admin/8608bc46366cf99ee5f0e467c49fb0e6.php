...
<html lang="en">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form action='/admin.php/Video/videojoin' method="get">
                <div class="seachform">
                            ...
                            <div class="table-responsive">
                                <form action="/admin.php/Video/del" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php if(is_array($video)): foreach($video as $key=>$video): ?><tbody>
                                            <tr>
                                                <td class="center">
                                                    <label>
                                                        <input type="checkbox" name="id[]" value="<?php echo ($video["joinid"]); ?>" class="ace" />
                                                        <span class="lbl"></span>
                                                    </label>
                                                </td>
                                                <td class="hidden-480"><?php echo ($video["joinid"]); ?></td>
                                                <td class="hidden-480"><?php echo ($video["videoname"]); ?></td>
                                                <td class="hidden-480"><?php echo ($video["username"]); ?></td>
                                                <td><?php echo ($video["phone"]); ?></td>
                                                <td class="hidden-480"><?php echo ($video["jointime"]); ?></td>
                                                <td class="hidden-480"><?php echo ($video["money"]); ?></td>
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                        <a onclick=" return confirm('你确定删除吗？')" href='/admin.php/Video/deljoin/joinid/<?php echo ($video["joinid"]); ?>'>
                                                            删除
                                                        </a>
