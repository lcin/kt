    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/admin.php/Teacher/index' method="get">
                    <div class="seachform">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/admin.php/Teacher/del">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($teachers)): foreach($teachers as $key=>$teacher): ?><tbody> 
									
										<tr>
											<td class="center">
												<label>
													<input type="checkbox" name="id[]" value="<?php echo ($teacher["id"]); ?>" class="ace" />
													<span class="lbl"></span>
												</label>
											</td>
                                            <td>
                                            ...
                                            <td class="hidden-480">
												<img src="/Public/Upload/<?php echo ($teacher["photo"]); ?>" width="40" height="40">
											</td>
                                            <td class="hidden-480"><?php echo ($teacher["organ"]); ?></td>
                                            <td class="hidden-480"><?php echo ($teacher["description"]); ?></td>
                       
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a  href='/admin.php/Teacher/mod/id/<?php echo ($teacher["id"]); ?>'>
                                                        修改 |
                                                    </a>

                                                    <a onclick=" return confirm('你确定删除吗？')" href='/admin.php/Teacher/del/id/<?php echo ($teacher["id"]); ?>'>
                                                        删除 
                                                    </a>
