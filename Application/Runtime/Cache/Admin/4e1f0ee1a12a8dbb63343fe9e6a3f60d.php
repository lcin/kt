					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/admin.php/User/add">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 邮箱 </label>

										<div class="col-sm-9">
											<input  type="email"  name="email" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="163@.cn" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-2" name="pwd" placeholder="Password" class="col-xs-10 col-sm-5" />
