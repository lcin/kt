...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
						 ...
						 <form action='/admin.php/Advice/index' method="get">
							<div class="seachform" >
							意见标题<input name="title" type="text" placeholder="请输入标题" class="scinput" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/admin.php/Advice/del">
											...
											<?php if(is_array($datas)): foreach($datas as $key=>$data): ?><tbody>
													<tr>
														...
														<td class="hidden-480"><?php echo ($data["advice"]); ?></td>
														<td><?php echo ($data["time"]); ?></td>

														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="red" href="/admin.php/Advice/del/id/<?php echo ($data["id"]); ?>">
