	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="alert alert-block alert-success">
				...
				<i class="icon-ok red" style="font-size:30px">欢迎 <?php echo ($_SESSION['admin']['name']); ?></i>
			...
			<div class="row">
				...
				<div class="col-sm-7 infobox-container" style="margin-left:200px">
					<div class="infobox infobox-green  ">
						...
						<div class="infobox-data">
							<span class="infobox-content"style="font-size:12px">视频观看次数</span>
							<div class="infobox-content" style="font-size:25px;color:green"><?php echo ($video['0']['num']); ?></div>
						</div>
						</div>
						<div class="stat stat-success" style="font-size:30px">
					</div>

					<div class="infobox infobox-pin" style="background:white">
						<div class="col-sm-7 infobox-container">
					<div class="infobox infobox-white infobox-small infobox-dark" style="width:220px;margin-right:110px">
						<div class="infobox-icon">
							<i class="icon-download-alt" style="background:green"></i>
						</div>

						<div class="infobox-data" style="margin-left:5px;">
							<div class="infobox-content" style="color:#000">下载次数</div>
							<div class="infobox-content" style="color:green;font-size:30px"><?php echo ($app); ?></div>
						</div>
					</div>
				</div>
					...
					<div class="infobox infobox-pink">
						...
						<div class="infobox-data">
							<span class="infobox-content"style="font-size:12px">视频总数</span>
							<div class="infobox-content" style="font-size:25px;color:green"><?php echo ($count); ?></div>
						</div>
			...
			<div class="row">
				<div class="col-sm-5"  style="width:99%;">
						...
						<div class="widget-body">
							<div class="widget-main no-padding">
								<table class="table table-bordered table-striped">
									...
									<tbody>
									<?php $num = '1'; ?>
									<?php if(is_array($videos)): foreach($videos as $key=>$video): ?><tr>
											<td><?php echo ($num++); ?></td>
											<td><?php echo ($video["title"]); ?></td>

											<td>
												<b class="green"><?php echo ($video["price"]); ?></b>
											</td>

											<td class="hidden-480">
												<span class="label label-info arrowed-right arrowed-in"><?php echo ($video["number"]); ?></span>
											</td>
