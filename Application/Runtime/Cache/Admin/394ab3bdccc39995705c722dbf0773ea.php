    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/admin.php/Info/index' method="get">
                    <div class="seachform">
                        公告标题: <input name="title" type="text" placeholder="请输入公告名称" class="scinput" />
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/admin.php/Info/del">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($infos)): foreach($infos as $key=>$info): ?><tbody> 
										<tr>
											<td class="center">
												<label>
													<input type="checkbox" name="id[]" value="<?php echo ($info["id"]); ?>" class="ace" />
													<span class="lbl"></span>
												</label>
											</td>
                                            <td>
                                            ...
                                            <td class="hidden-480"><?php echo ($info["content"]); ?></td>
                                            <td class="hidden-480"><?php echo ($info["time"]); ?></td>
            
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a  href='/admin.php/Info/mod/id/<?php echo ($info["id"]); ?>'>
                                                        修改 |
                                                    </a>

                                                    <a onclick="return confirm('你确认删除吗')" href='/admin.php/Info/del/id/<?php echo ($info["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Info/mod/id/{infos.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Info/del/id/{infos.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
