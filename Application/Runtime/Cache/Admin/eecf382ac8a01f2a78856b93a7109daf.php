    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/admin.php/Adv/index' method="get">
                    <div class="seachform">
                        广告名称: <input name="des" type="text" placeholder="请输入广告描述" class="scinput" />
                        ...
                        <div class="col-xs-12">
							...
							<form action="/admin.php/Adv/del">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($advs)): foreach($advs as $key=>$adv): ?><tbody> 
										<tr>
											<td class="center">
												<label>
													<input type="checkbox" name="id[]" value="<?php echo ($adv["id"]); ?>" class="ace" />
													<span class="lbl"></span>
												</label>
											</td>
                                            <td>
                                            ...
                                            <td class="hidden-480"><img src="/Public/Upload/<?php echo ($adv["pic"]); ?>" width="40px" height="40px"></td>
                                            <td class="hidden-480"><?php echo ($url); ?></td>
                                            <td class="hidden-480"><?php echo ($adv["des"]); ?></td>
                                            <td class="hidden-480">
											<?php switch($adv["place"]): case "0": ?>首页轮播<?php break;?>
											<?php case "1": ?>热门广告<?php break;?>
											<?php case "2": ?>尾部左侧广告<?php break;?>
											<?php case "3": ?>尾部右侧广告<?php break; endswitch;?>
											</td>
            
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a  href='/admin.php/Adv/mod/id/<?php echo ($adv["id"]); ?>'>
                                                        修改 |
                                                    </a>

                                                    <a href='/admin.php/Adv/del/id/<?php echo ($adv["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Adv/mod/id/{adv.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Adv/del/id/{adv.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
