					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/admin.php/Info/add">
											
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 公告标题 </label>

										<div class="col-sm-9">
											<input  type="text"  name="title" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="请输入广告标题" />
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" name="content" for="form-field-2"> 公告内容</label>

									<div class="col-sm-9">
										<textarea  type="text"  name="content" placeholder="请输入公告内容" class="col-xs-10 col-sm-5" style="width:325px;height:150px">
										</textarea>
									</div>
								</div>
