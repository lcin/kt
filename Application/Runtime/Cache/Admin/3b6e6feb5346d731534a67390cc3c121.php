					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/admin.php/Index/index.html">后台主页</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/admin.php/Type/del" method="post">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php if(is_array($types)): foreach($types as $key=>$type): ?><tr>
														...
														<td>
															...
															<?php if($type["pid"] == 0): ?><img src="/Public/Admin/assets/avatars/1.gif">
															<?php else: ?>
																<img src="/Public/Admin/assets/avatars/2.gif"><?php endif; ?>
														...
														<?php if($type["pid"] == 0): ?><td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																	<a class="purple" href="/admin.php/Type/add_son/id/<?php echo ($type["id"]); ?>">
																	<i class="icon-plus bigger-130">添加子版块</i>
																</a>

																<a class="green" href="/admin.php/Type/mod_parent/id/<?php echo ($type["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>
                                                               <?php if($type['son'] == '0'): ?><a class="red" onclick="return confirm('你确认要删除吗')" href="/admin.php/Type/del/id/<?php echo ($type["id"]); ?>">
														...
														<?php else: ?>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																	<a class="purple" href="/admin.php/Type/select/id/<?php echo ($type["id"]); ?>">
																	<i class="icon-plus bigger-130">查看</i>
																</a>

																<a class="green" href="/admin.php/Type/mod_son/id/<?php echo ($type["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>
                                                                <?php if($type['video'] == '0'): ?><a class="red" onclick="return confirm('你确定要删除吗')" href="/admin.php/Type/del/id/<?php echo ($type["id"]); ?>">
																	<i class="icon-trash bigger-130">删除</i>
																</a><?php endif; ?>
															</div>
														</td><?php endif; ?>
