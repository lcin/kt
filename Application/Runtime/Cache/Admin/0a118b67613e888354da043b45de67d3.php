...
<div class="main-content">
					...
					<div class="page-content">
						...
						<!--搜索-->
						<form class="form-search" method="get" action="/admin.php/Course/index">
							<div>
								<span>课时标题：</span>
								<input type="text" name="name" placeholder="请输入章节名" class="nav-search-input" id="nav-search-input" autocomplete="off" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/admin.php/Course/del" method="post">
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($courses)): foreach($courses as $key=>$course): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" name="id[]" value="<?php echo ($course["id"]); ?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td class="hidden-480"><?php echo ($course["time"]); ?></td>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/admin.php/Course/mod/id/<?php echo ($course["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" onclick="return confirm('你确认要删除吗')" href="/admin.php/Course/del/id/<?php echo ($course["id"]); ?>">
