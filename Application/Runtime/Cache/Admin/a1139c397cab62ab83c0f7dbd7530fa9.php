    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/admin.php/Video/index' method="get">
                    <div class="seachform">
                        课程名称: <input name="title" type="text" class="scinput" placeholder="请输入课程名称" />
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/admin.php/Video/del" method="post">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($videos)): foreach($videos as $key=>$video): ?><tbody> 
										<tr>
											<td class="center">
												<label>
													<input type="checkbox" name="id[]" value="<?php echo ($video["id"]); ?>" class="ace" />
													<span class="lbl"></span>
												</label>
											</td>
											...
											<td class="hidden-480"><?php echo ($video["nid"]); ?></td>
                                            <td class="hidden-480"><?php echo ($video["tid"]); ?></td>
                                            <td class="hidden-480"><?php echo ($video["pid"]); ?></td>
                                            <td><?php echo ($video["title"]); ?></td>
                                         
                                            <td class="hidden-480">
											
												<img src="/Public/Upload/<?php echo ($video["video"]); ?>" width="40" height="40">
											</td>
                                            <td class="hidden-480"><?php echo ($video["price"]); ?></td>
                                            <td class="hidden-480"><?php echo ($video["number"]); ?></td>
                                            
            
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                   
													<a  href='/admin.php/Video/mod/id/<?php echo ($video["id"]); ?>'>
                                                        修改 |
                                                    </a>
                                                    <a onclick=" return confirm('你确定删除吗？')" href='/admin.php/Video/del/id/<?php echo ($video["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        <button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown">
                                                            <i class="icon-cog icon-only bigger-110">查询</i>
                                                        </button>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Video/mod/id/{video.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Video/del/id/{video.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
