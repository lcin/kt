...
<html lang="en">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form action='/admin.php/Activity/join' method="get">
                <div class="seachform" >
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-responsive">
                                <form action="/admin.php/Activity/deljoin">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php if(is_array($datas)): foreach($datas as $key=>$data): ?><tbody>
                                            <tr>
                                                ...
                                                <td><?php echo ($data["jointime"]); ?></td>
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a class="red" href="/admin.php/Activity/deljoin/joinid/<?php echo ($data["joinid"]); ?>">
