...
<html lang="en">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form action='/admin.php/Userdemand/demand' method="get">
                <div class="seachform">
                    查询内容: <input name="des" type="text" placeholder="你想要找到什么？" class="scinput" />
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/admin.php/Userdemand/del">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php if(is_array($demand)): foreach($demand as $key=>$demand): ?><tbody>
                                            <tr>
                                                <td class="center">
                                                    <label>
                                                        <input type="checkbox" name="id[]" value="<?php echo ($demand["id"]); ?>" class="ace" />
                                                        <span class="lbl"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                ...
                                                <td class="hidden-480"><?php echo ($demand["content"]); ?></td>
                                                <td class="hidden-480"><?php echo ($demand["address"]); ?></td>
                                                <td class="hidden-480"><?php echo ($demand["tell"]); ?></td>
                                                <td class="hidden-480"><?php echo ($demand["uptime"]); ?></td>

                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
<!--                                                        <a  href='/admin.php/Userdemand/mod/id/<?php echo ($demand["id"]); ?>'>-->
<!--                                                            修改 |-->
<!--                                                        </a>-->

                                                        <a href='/admin.php/Userdemand/del/id/<?php echo ($demand["id"]); ?>'>
                                                            删除
                                                        </a>
                                                    ...
                                                    <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                        <div class="inline position-relative">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                                ...
                                                                <li>
                                                                    <a href="/admin.php/Userdemand/mod/id/{adv.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                                ...
                                                                <li>
                                                                    <a href="/admin.php/Userdemand/del/id/{adv.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
