    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/admin.php/Organ/index' method="get">
                    <div class="seachform">
                        合作机构名称: <input name="name" type="text" placeholder="请输入机构名称" class="scinput" />
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/admin.php/Organ/del">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
											<th class="center">
												<label>			
												<input type="submit" onclick="return confirm('你确认要删除吗？')"  value="删除" class="btn btn-primary btn-xs" />
												</label>
											</th>
                                            <th>合作机构编号</th>
                                            <th>合作机构名称</th>
                                    ...
                                    <?php if(is_array($organs)): foreach($organs as $key=>$organ): ?><tbody> 
										<tr>
											<td class="center">
												<label>
													<input type="checkbox" name="id[]" value="<?php echo ($organ["id"]); ?>" class="ace" />
													<span class="lbl"></span>
												</label>
											</td>
                                            <td>
                                            ...
                                            <td><?php echo ($organ["name"]); ?></td>
                                         
                                            <td class="hidden-480"><?php echo ($organ["url"]); ?></td>
                                            <td class="hidden-480"><?php echo ($organ["description"]); ?></td>
            
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a  href='/admin.php/Organ/mod/id/<?php echo ($organ["id"]); ?>'>
                                                        修改 |
                                                    </a>

                                                    <a href='/admin.php/Organ/del/id/<?php echo ($organ["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Organ/mod/id/{organ.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/Organ/del/id/{organ.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
