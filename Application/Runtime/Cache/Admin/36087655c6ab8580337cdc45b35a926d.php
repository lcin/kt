    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/admin.php/News/index' method="get">
                    <div class="seachform">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/admin.php/News/del">
										...
										<tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a  href='/admin.php/News/mod/id/<?php echo ($news["id"]); ?>'>
                                                        修改 |
                                                    </a>

                                                    <a href='/admin.php/News/del/id/<?php echo ($news["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/News/mod/id/{news.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/admin.php/News/del/id/{news.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
