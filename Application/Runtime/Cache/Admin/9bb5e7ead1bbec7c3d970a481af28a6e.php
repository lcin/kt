				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="/admin.php/Config/index" method ="post" >
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<tr>
											...
											<td><?php echo ($configs["keywords"]); ?></td>
										<td class="hidden-480"><?php echo ($configs["description"]); ?></td>
											<td class="hidden-480"><?php echo ($configs["copyright"]); ?></td>
											<td class="hidden-480"><img width="40" height="40"  src="/Public/Upload/<?php echo ($configs["logo"]); ?>"></td>
											<td><?php echo ($configs['status'] == '0'? "禁用" :"启用"); ?></td>

											<td>
											
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													<a class="blue" href="/admin.php/Config/status/id/<?php echo ($configs["id"]); ?>/status/<?php echo ($configs["status"]); ?>">
														<i class="icon-zoom-in bigger-130">
															<?php echo ($configs['status'] == '0' ?"启用":"禁用"); ?>
														
														</i>
														
													</a>

													<a class="green" href="/admin.php/Config/mod/id/<?php echo ($configs["id"]); ?>">
