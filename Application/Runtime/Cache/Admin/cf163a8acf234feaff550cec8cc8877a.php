				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="/admin.php/Download/index" method ="post" >
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<td class="hidden-480"><?php echo ($app["filename"]); ?></td>
										<td class="hidden-480"><?php echo ($app["time"]); ?></td>
										<td class="hidden-480"><?php echo ($app["addr"]); ?></td>
									<!-- 	<td>
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
												<a class="blue" href="/admin.php/Download/status/id/<?php echo ($configs["id"]); ?>/status/<?php echo ($configs["status"]); ?>">
													<i class="icon-zoom-in bigger-130">
													</i>
												</a>
												<a class="green" href="/admin.php/Download/mod/id/<?php echo ($configs["id"]); ?>">
